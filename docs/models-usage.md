...
```js
const User = sequelize.define('user', { name: new Sequelize.STRING() })
const Task = sequelize.define('task', { name: new Sequelize.STRING() })
const Tool = sequelize.define('tool', { name: new Sequelize.STRING() })
