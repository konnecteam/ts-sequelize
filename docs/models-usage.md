...
```js
const User = sequelize.define('user', { name: new DataTypes.STRING() })
const Task = sequelize.define('task', { name: new DataTypes.STRING() })
const Tool = sequelize.define('tool', { name: new DataTypes.STRING() })
