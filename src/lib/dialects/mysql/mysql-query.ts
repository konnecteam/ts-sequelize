...
export class MysqlQuery extends AbstractQuery {
  ...
  constructor(connection, sequelize : Sequelize, options : { instance?, model? }) {
    super();
   ...
   * @hidden
   */
  private logWarnings(results : any) : Promise<any> {
  ...
  public formatError(err : { errno?, code?, message? : string }) : Error {
