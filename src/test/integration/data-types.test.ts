...
describe(Support.getTestDialectTeaser('DataTypes'), () => {
  ...
  it('calls parse and stringify for ENUM', () => {
    const Type = (DataTypes as any).ENUM('hat', 'cat');
