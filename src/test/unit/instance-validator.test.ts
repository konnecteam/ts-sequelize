...
describe(Support.getTestDialectTeaser('InstanceValidator'), () => {
  ...
  beforeEach(() => {
    User = Support.sequelize.define<ItestInstance, ItestAttribute>('user', {
      fails: {
  ...
  describe('_validateAndRunHooks', () => {
    beforeEach(() => {
      this.successfulInstanceValidator = new InstanceValidator(User.build());
