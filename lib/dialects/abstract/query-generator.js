  ...
  */
  ...
  generateInclude(include, parentTableName, topLevelInfo) {
    ...
    if (include.through) {
      ...
      const hasLimitRequiredHasMany = topLevelInfo.options.limit && include.required && !(include.parent.association instanceof HasMany) && include.association instanceof HasMany ? true : false;
