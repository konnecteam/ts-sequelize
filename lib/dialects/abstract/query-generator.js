  ...
  */
  ...
  generateInclude(include, parentTableName, topLevelInfo) {
    ...
    if (topLevelInfo.options.includeIgnoreAttributes !== false) {
      ...
      if (include.subQuery && topLevelInfo.subQuery && !(include.mismatch) && isNotHMorBTM) {
        ...
        if (topLevelInfo.subQuery && Model.hasParentMismatchOrRequired(include) && (isNotHMorBTM || include.mismatch)) {
          for (const attr of includeAttributes) {
            attributes.subQuery.push(attr);
          }
        } else {
    ...
    if (include.through) {
      ...
      if (!(Model.hasParentInSubQuery(include)) && notFromBTM && include.required === true && !(include.mismatch) && (hasLimitRequiredHasMany || (topLevelInfo.subQuery && include.subQueryFilter))) {
