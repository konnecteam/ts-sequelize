  ...
  */
  ...
  generateInclude(include, parentTableName, topLevelInfo) {
    ...
    if (include.through) {
      ...
      const hasRequiredHasMany = include.required && include.association instanceof HasMany ? true : false;

      if (hasRequiredHasMany || (topLevelInfo.subQuery && include.subQueryFilter)) {
