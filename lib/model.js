...
class Model {
  ...
  static _validateIncludedElements(options, tableNames) {
    ...
    options.include = options.include.map(include => {
      ...
      if (include.duplicating === undefined) {
        include.duplicating = include.association.isMultiAssociation || (include.required && include.parent.association && include.parent.association.isMultiAssociation && Model.hasParentLimit(include));
      }
  ...
  static getFullAsPath(include) {
    ...
    while (parent && parent.parent) {
      pathArray.push(parent.model.name);
      parent = parent.parent;
    }
