...
class Model {
    ...
    for (const include of options.include) {
      ...
      if (include.subQuery !== false && options.hasDuplicating && options.topLimit) {
        if (include.duplicating) {
          ...
          include.subQuery =  include.mismatch || include.hasRequired;
          include.subQueryFilter = false;
        }
      } else {
        include.subQuery =  include.mismatch || include.subQuery || false;
        if (include.duplicating) {
          include.subQueryFilter = include.subQuery;
          include.subQuery = false;
        } else {
          include.subQueryFilter = false;
          include.subQuery =  include.mismatch || include.subQuery || (include.hasParentRequired && include.hasRequired && Model.hasReqOrParentRequired(include, false));
        }
      }
  ...
  static hasParentInSubQuery(include) {
    let parent = include.parent;
